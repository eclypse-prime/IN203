...
int main()
{
    ...
    std::vector<std::seed_seq::result_type> buddha1;
    std::vector<std::seed_seq::result_type> buddha2;
    std::vector<std::seed_seq::result_type> buddha3;

    std::chrono::time_point<std::chrono::system_clock> global_start, global_end;
    std::chrono::duration<double> global_elapsed_seconds;
    ...
    buddha1 = bhuddabrot( 15000000, l1, width, height );
    end = std::chrono::system_clock::now();
    elapsed_seconds = end-start;
    std::cout << "Temps calcul Bhudda 1 : " << elapsed_seconds.count() << std::endl;

    std::cerr << "Bhudda 2\n";
    start = std::chrono::system_clock::now();
    buddha2 = bhuddabrot( 5000000, l2, width, height );
    end = std::chrono::system_clock::now();
    elapsed_seconds = end-start;
    std::cout << "Temps calcul Bhudda 2 : " << elapsed_seconds.count() << std::endl;

    std::cerr << "Bhudda 3\n";
    start = std::chrono::system_clock::now();
    buddha3 = bhuddabrot( 300000, l3, width, height );
    end = std::chrono::system_clock::now();
    elapsed_seconds = end-start;
    std::cout << "Temps calcul Bhudda 3 : " << elapsed_seconds.count() << std::endl;

    global_end = std::chrono::system_clock::now();
    global_elapsed_seconds = global_end-global_start;
    std::cout << "Temps calcul total : " << global_elapsed_seconds.count() << std::endl;
